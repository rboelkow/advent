...
def duplicate_frequency_detector(list_of_frequency_changes,
                                 starting_frequency=0):
...
print(duplicate_frequency_detector(frequency_changes_list))